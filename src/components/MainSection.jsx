...
function MainSection() {
    ...
    return (
        <motion.div id='home'
            ...
            className='lg:h-[100vh] h-screen lg:py-0 py-7 relative z-10 text-white flex justify-center lg:pl-0  items-center pt-16 lg:pt-0'>
            <div className=''>
                ...
                <div className='w-[90vw] lg:w-[50vw]'>
                    <p className='mt-7 text-[#EBECF3] text-sm lg:text-lg font-normal' >
                        <p className='mt-5 text-[#EBECF3] opacity-80 text-base lg:text-lg font-normal'>
