      ...
      <div className='flex lg:space-x-20 lg:space-y-0 space-y-16 flex-col lg:flex-row mt-5 px-5 lg:px-0 items-center mb-10 justify-center'>
        <div>
          ...
          <div className='flex  items-center'>
            <div>
              <h1 className='font-extrabold mt-5 text-base lg:text-[22px]'>Coder Army Clone</h1>
            </div>
            <div className='mt-2'>
              <div className='border-t ml-3 mr-3 border-[#EBECF3] opacity-40 inline-block w-[33vw] lg:w-[210px]'></div>
            </div>
            <div className='mt-3'>
              <span>
                <a href="">
          ...
          <div className='flex mt-3 items-center'>
            <p className='text-lg text-[#EBECF3] opacity-80  '>A clone App of Coder Army coaching app for students <br className='lg:flex hidden'/>  learning to DSA. This app is designed and built on <br className='lg:flex hidden'/> my own</p>
          </div>
        </div>
      ...
      <div className='flex lg:space-x-20 lg:space-y-0 space-y-16 px-6 lg:px-0 mt-14 flex-col lg:flex-row justify-center'>
        <div>
          <div className='bg-[#232323] flex justify-center overflow-hidden pt-14 w-[85vw] lg:w-[31vw] lg:h-[35vh] h-[30vh]'>
            ...
            <div className=''>
              <div className='flex items-center '>
                <div>
                <h1 className='font-extrabold mt-5 text-base lg:text-[22px]'>Space-X Clone</h1>
                </div>
                <div className='mt-3'>
                <div className='border-t ml-3 mr-3  border-[#EBECF3] opacity-40 inline-block w-[40vw] lg:w-[250px]' />
                </div>
                <div className='mt-3'>
                     <span>
                    <a href="">
        ...
        <div>
          ...
          <div >
            <div className='flex items-center'>
              <div>
                <h1 className='font-extrabold mt-5 text-base lg:text-[22px]'>Adidas E-commerene</h1>
              </div>
              <div className='mt-3'>
                <div className='border-t ml-3 mr-3  border-[#EBECF3] opacity-40 inline-block w-[23vw] lg:w-[185px]'></div>
              </div>
              <div className='mt-3'>
                <span>
